...
export const WEB_TITLE = 'Koas Portfolio'
export const WEB_DESCRIPTION =
  'A personal website showcasing my work and projects.'
export const FOOTER_COPYRIGHT = '© 2025 Le Cong Anh Khoa.'
export const FOOTER_LINK = 'https://github.com/AnhKhoaaaa'

export const NAME = 'Le Cong Anh Khoa'
export const JOB_TITLE = 'HCMUS Student'
